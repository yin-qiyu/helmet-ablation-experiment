...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='models/yolov5n-Helmet.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/helmet.yaml', help='dataset.yaml path')
    parser.add_argument('--hyp', type=str, default=ROOT / 'data/hyps/hyp_evolve.yaml', help='hyperparameters path')
...
if __name__ == "__main__":
    wandb.init(project="helmet", entity="yin-qiyu")
    opt = parse_opt()
    main(opt)
